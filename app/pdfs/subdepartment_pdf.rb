...
class SubdepartmentPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Sub Department List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
    ...
    move_down 15
      ...
      cells.padding                    = 1
      cells.min_width                  = 150      
      row(1..5000).column(0..5).border_width = 1
 ...
 def line_item_rows   
    [["SlNo.","Code","Description","Department"]]+
    @invoice.each.map do |inv|
       [count,inv.departCode,inv.departDescription,inv.department]
    end
end
