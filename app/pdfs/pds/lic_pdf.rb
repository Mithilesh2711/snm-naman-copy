...
move_down 30
data24 = ([
  [{:content => "This is to certify that "+typeofx2.to_s+" "+(@seawdarsobj ? @seawdarsobj.sw_sewadar_name : '' ).to_s+" "+typeofx.to_s+" "+namex.to_s+" is doing sewa at \n"+@compDetail.cmp_addressline1.to_s.to_s+""},
    {:content => ""},
    {:content => ""}]
])
...
data25 = ([
  [{:content =>""+typeofme2.to_s+" is residing at "+personaladdress.to_s+" in an  accomodation provided by Sant Nirankari Mandal."},
   {:content => ""},
   {:content => ""}]
])
