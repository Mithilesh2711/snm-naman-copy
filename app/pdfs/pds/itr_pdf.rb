...
class ItrPdf < Prawn::Document
  ...
  ddated   = Date.today.strftime("%d-%m-%Y")
data21 = ([
...
move_down 30
data22 = ([
  [{:content => "SNM/HRD"+@seawdarsobj.sw_sewcode.to_s},
   {:content => ""},
   {:content => "Dated : "+ddated.to_s}]
...
move_down 20
data24 = ([
  [{:content => "This is to certify that "+typeofx2.to_s+" "+(@seawdarsobj ? @seawdarsobj.sw_sewadar_name : '' ).to_s+" "+typeofx.to_s+" "+namex.to_s+" is doing sewa at "+@compDetail.cmp_addressline1.to_s.to_s+". "+typeofme2.to_s+" has been paid Maintenance Allowance etc. during the financial year 2020-21 as under:-"},
    {:content => ""},
    {:content => ""}]
])
...
data26 = ([
  [{:content => "S.No."}, {:content => "Name of Allowance"},{:content => " "},{:content => "Amount"}],
    [{:content =>"1."},{:content =>"Maintenance Allowance"},{:content =>" "},{:content =>"Rs.4,32,492/-"}],
    [{:content =>"2."},{:content =>"SamagamAshirwad"},{:content =>" "},{:content =>"+Rs.7,208/-"}],
    [{:content => " "},{:content => " "},{:content => "Total"},{:content => "Rs.4,39,700/-"}]
])
table([] + data26, :width => 528) do
  ...
  style row(3), :size => 11 , :align => :left ,  :font_style => :bold , :border_left_width => 0, :border_right_width => 0
  style row(0..3).column(0), :size => 11 , :align => :left , :border_width => 0 , :width => 60
  style row(0..3).column(1), :size => 11 , :align => :left , :border_width => 0 , :width => 204
  style row(0..3).column(2), :size => 11 , :align => :left , :border_width => 0 , :width => 132
  style row(0..3).column(3), :size => 11 , :align => :left , :border_width => 0 , :width => 132
...
data261 = ([
  [{:content => "S.No."}, {:content => "Deductions:-"},{:content => " "},{:content => "Amount"}],
    [{:content =>"1."},{:content =>"Maintenance Allowance"},{:content =>" "},{:content =>"Rs.4,32,492/-"}],
    [{:content =>"2."},{:content =>"SamagamAshirwad"},{:content =>" "},{:content =>"(-)Rs.7,208/-"}],
    [{:content => " "},{:content => " "},{:content => "Total Deductions"},{:content => "Rs.4,39,700/-"}]
])
table([] + data261, :width => 528) do
  style row(0), :size => 11 , :align => :left ,  :font_style => :bold , :border_width => 0
  style row(1), :size => 11 , :align => :left , :border_width => 0
  style row(2), :size => 11 , :align => :left ,  :border_width => 0
  style row(3), :size => 11 , :align => :left ,  :font_style => :bold , :border_left_width => 0, :border_right_width => 0
...
data263 = ([
    ...
    [{:content => " "},{:content => " "},{:content => "Amount Paid"},{:content => "Rs.3,47,502/-"}]
])
table([] + data263, :width => 528) do
 



  style row(0), :size => 11 , :align => :left ,  :font_style => :bold , :border_left_width => 0, :border_right_width => 0
  style row(0..3).column(0), :size => 11 , :align => :left , :font_style => :bold , :border_left_width => 0, :border_right_width => 0 , :width => 60
  style row(0..3).column(1), :size => 11 , :align => :left ,:font_style => :bold , :border_left_width => 0, :border_right_width => 0 , :width => 204
  style row(0..3).column(2), :size => 11 , :align => :left , :font_style => :bold , :border_left_width => 0, :border_right_width => 0, :width => 132
  style row(0..3).column(3), :size => 11 , :align => :left , :font_style => :bold , :border_left_width => 0, :border_right_width => 0, :width => 132
...
data28 = ([
  [{:content => ""},
    {:content =>"This certificate is issued at the request of "+typeofx2.to_s+" "+(@seawdarsobj ? @seawdarsobj.sw_sewadar_name : '' ).to_s+" for filing Income Tax Return."},
    {:content => ""}]
])
...
table([] + data27, :width => 528) do
  style row(0), :border_width => 0 , :size => 11 , :align => :left, :font_style => :bold
  style column(0..1), :width => 190
end
