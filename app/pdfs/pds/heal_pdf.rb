...
move_down 30
data24 = ([
  [{:content => "This is to certify that "+typeofx2.to_s+" "+(@seawdarsobj ? @seawdarsobj.sw_sewadar_name : '' ).to_s+" "+typeofx.to_s+" "+namex.to_s+" R/O Sant Nirankari Mandal, H.No.3/328, Dung House, Snt Nirankari Colony, Delhi - 110009 has been rendering sewa at "+@compDetail.cmp_addressline1.to_s.to_s+" since "+@seawdarsobj.sw_joiningdate.to_s+". As per our records, "+typeofme2.to_s+" is being paid Rs 36,713/- (Rupees thirty six thousand seven hundred and thirteen only) per month as maintenance allowance."},
    {:content => ""},
    {:content => ""}]
])
...
data28 = ([
  [{:content => ""},
    {:content =>"This certificate is issued for the purpose of police verification as required for Guard Retainer of \n"+@compDetail.cmp_addressline1.to_s.to_s+""},
    {:content => ""}]
])
