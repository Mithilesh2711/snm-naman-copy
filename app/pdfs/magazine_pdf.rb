...
class MagazinePdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Magazine List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.","MagzineCode","MagazineName","Language","No of Magazine/year"]]+
      @invoice.each.map do |inv|
         [count,inv.mag_code,inv.mag_name,inv.mag_language,inv.mag_frequency]
      end
  end
