...
class AddressPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Address</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["Sl. No.", "Code", "Member", "Name", "Mobile", "Email", "Address", "Status"]]+
      @invoice.each.map do |inv|
         [count,inv.adr_code, inv.adr_membercode, inv.adr_name, inv.adr_mobile , inv.adr_email , inv.adr_fulladdress, inv.adr_status]
      end
  end
