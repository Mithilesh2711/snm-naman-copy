...
class CityPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>City List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","StateCode\State","DistrictCode\District","CityCode","Description"]]+
    @invoice.each.map do |inv|
       [count,inv.ct_statecode.to_s+"\n"+inv.statename.to_s,inv.ct_districtcode.to_s+"\n"+inv.distname.to_s,inv.ct_citycode,inv.ct_description]
    end
end
