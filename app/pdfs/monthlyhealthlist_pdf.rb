...
class MonthlyhealthlistPdf < Prawn::Document
...
data4 = ([
  [{:content =>"S No."}, {:content =>"Sewadar Code"},   {:content =>"Name\nDepartment"},{:content =>"Health Policy"}, {:content =>"Health Slab"}],
...
if @salary && @salary.length >0
         @salary.each do |newsalry|          
          ...
          data5 += ([
            [{:content =>mycount.to_s}, {:content =>newsalry.sw_sewcode.to_s},{:content =>newsalry.sw_sewadar_name.to_s+"\n"+newsalry.departname.to_s},  {:content =>newsalry.so_healthinsurance.to_s}, {:content =>newsalry.so_healthslab.to_s}]
