...
class DesignationPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Designation List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","DesignationCode","Description","Type"]]+
    @invoice.each.map do |inv|
       [count,inv.desicode,inv.ds_description,inv.ds_type]
    end
end
