...
class MagazineReceiptPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Magazine Receipt List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.", "Code ", "Member ", "Magazine ", "Subscription ", "CreatedBy ", "ModifiedBy ", "CurrencyAmount ", "TotalAmount ", "PaymentMode",  "BankName",  "DocumentNo", "ManualReceiptNo", "ManualReceiptDate ", "AccountReceiptNo", "AccountReceiptDate",  "Status"]]+
      @invoice.each.map do |inv|
         [count, inv.mr_code , inv.mr_member , inv.mr_magazine , inv.mr_subscription , inv.mr_createdby , inv.mr_modifiedby , inv.mr_currencyamount , inv.mr_amount , inv.mr_paymentmode , inv.mr_bankname , inv.mr_documentnum , inv.mr_manualrectnum , inv.mr_manualrectdate , inv.mr_accountrectnum , inv.mr_accountrectdate , inv.mr_status]
      end
  end
