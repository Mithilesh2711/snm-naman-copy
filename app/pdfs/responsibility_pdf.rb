...
class ResponsibilityPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Responsibility List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","Code","Description"]]+
    @invoice.each.map do |inv|
       [count,inv.rsp_rspcode,inv.rsp_description]
    end
end
