...
class CourierPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Courier List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      ...
      @invoice.each.map do |inv|
         [count,inv.cr_code,inv.cr_name,inv.cr_status]
      end
  end
