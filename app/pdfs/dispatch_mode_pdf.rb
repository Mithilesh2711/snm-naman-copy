...
class DispatchModePdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Dispatch Mode List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      ...
      @invoice.each.map do |inv|
         [count,inv.dm_code,inv.dm_name,inv.dm_status]
      end
  end
