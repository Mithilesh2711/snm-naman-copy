...
class DistrictPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>District List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","StateName","DistrictCode","Description"]]+
    @invoice.each.map do |inv|
       [count,inv.sts_description,inv.dts_districtcode,inv.dts_description]
    end
end
