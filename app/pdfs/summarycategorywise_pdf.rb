...
class SummarycategorywisePdf < Prawn::Document
 ...
 move_down 10
 text "Category Wise Report ", :size => 11,:font_style => :bold
        move_up 12
...
mycount    = 1
data5 = ([
  [{:content =>"S No."}, {:content =>"Category"},   {:content =>"Sanctioned Amount"},{:content =>"Repaid Amount"}, {:content =>"Outstanding Amount"}],
...
if @salary && @salary.length >0
         @salary.each do |newsmry|          
          ...
          data5 += ([
            [{:content =>mycount.to_s}, {:content =>newsmry.categoryname.to_s},{:content =>newsmry.sanctionamount.to_i.to_s},  {:content =>newsmry.totalrepaid.to_i.to_s}, {:content =>newsmry.totaloutstanding.to_i.to_s}]
