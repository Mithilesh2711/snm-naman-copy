...
class SublocationPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Sub Location List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","Description","Location"]]+
    @invoice.each.map do |inv|
       [count,inv.sl_description.to_s,inv.locations]
    end
end
