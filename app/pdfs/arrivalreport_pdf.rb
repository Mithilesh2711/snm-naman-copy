class ArrivalreportPdf < Prawn::Document
 ...
 text "Arrival Report"
        ...
        text "Print Date : "+format_oblig_date(Date.today).to_s, :size => 10, :align=>:right
            ...
            data4 = ([
              [{:content =>"S No."}, {:content =>"Employee Code"},   {:content =>"Name"},   {:content =>"Location\nDepartment"},   {:content =>"Shift"}, {:content =>"Arrival Time"}, {:content =>"Early Hrs"}, {:content =>"Remark"}],
       ...
       data4 += ([
         [{:content =>count.to_s}, {:content =>newpds.al_empcode}, {:content =>newpds.sw_sewadar_name.to_s},   {:content =>newpds.location.to_s+"\n"+newpds.mydepartment.to_s},   {:content =>newpds.al_shift.to_s},{:content =>newpds.al_arrtime.to_s}, {:content =>newpds.al_earlhrs.to_s}, {:content =>""}],
 ...
 table([] + data4,:width =>528)  do
  ...
  style row(0..5000).column(4..6), :align => :right
...
data6 = ([
 [{:content =>"Grand Total", :colspan => 2},  {:content =>""}, {:content =>""}, {:content =>""},{:content =>""},{:content =>newealhrs.to_s}, {:content =>""}],
