class OvertimedepartmentwisePdf < Prawn::Document
 ...
 text "Overtime Report"
        ...
        text "Print Date : "+format_oblig_date(Date.today).to_s, :size => 10, :align=>:right
            ...
            data4 = ([
              [{:content =>"S No."}, {:content =>"Employee Code"},   {:content =>"Name"},   {:content =>"Location\nDepartment"},   {:content =>"Arrival Time"}, {:content =>"Departure Time"},{:content =>"Work hours"}, {:content =>"Overtime"}],
       ...
       data4 += ([
         [{:content =>count.to_s}, {:content =>newpds.al_empcode}, {:content =>newpds.sw_sewadar_name.to_s},   {:content =>newpds.location.to_s+"\n"+newpds.mydepartment.to_s},   {:content =>newpds.al_arrtime.to_s},{:content =>newpds.all_deptime.to_s}, {:content =>newpds.al_workhrs.to_s}, {:content =>newpds.al_overtime.to_s}],
...
data6 = ([
 [{:content =>"Grand Total", :colspan => 2},  {:content =>""}, {:content =>""}, {:content =>""},{:content =>""},{:content =>newwkhrs.to_s}, {:content =>newovthrs.to_s}],
