...
class IndividualHeadPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>IndividualHead</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.","Code","Name","Country","State","District", "City", "Pincode", "Mobile", "Phone", "Email", "Address", "DispatchMode", "DispatchType", "Status"]]+
      @invoice.each.map do |inv|
         [count,inv.ih_code,inv.ih_name,inv.ih_country,inv.ih_state,inv.ih_district,inv.ih_city,inv.ih_pincode,inv.ih_mobile,inv.ih_phone,inv.ih_email,inv.ih_address,inv.ih_dispatch_mode,inv.ih_dispatch_type,inv.ih_status]
      end
  end
