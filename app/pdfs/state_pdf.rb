...
class StatePdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>State List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","StateCode","Description","Welfare","WelfareEmployer"]]+
    @invoice.each.map do |inv|
       [count,inv.sts_code,inv.sts_description,inv.sts_welfare,inv.sts_welfare_employer]
    end
end
