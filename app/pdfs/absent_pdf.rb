class AbsentPdf < Prawn::Document
  def initialize(attendance,compdetail,uRl,rsss,oths)
    super(:top_margin=>20,:bottom_margin=>30,:page_size => "A4" )
  ...
  if @attendance && @attendance.length >0
    @attendance.each do |newpds|
      ...
      fwovtmns  += ovtmns.to_i
       ...
       data4 += ([
         [{:content =>count.to_s}, {:content =>newpds.al_empcode+"\n"+newpds.sw_sewadar_name.to_s},   {:content =>newpds.location.to_s+"\n"+newpds.mydepartment.to_s},   {:content =>newpds.al_shift.to_s},{:content =>""}],
...
data6 = ([
 [{:content =>"Grand Total", :colspan => 2}, {:content =>"" }, {:content =>""}, {:content =>""}],
