...
class MarriagevoucherPdf < Prawn::Document
 ...
 def line_item_rows   
    ...
    @invoice.each.map do |inv|
      ...
      if inv.refercode !=nil && inv.refercode !=''
       ...
       [count,inv.ama_sewadarcode.to_s+newrefrcode.to_s+"\n"+inv.sewdarname.to_s+"\n"+inv.department.to_s+"\n"+inv.deginname.to_s,inv.ama_requestno.to_s+"\n"+formatted_date(inv.ama_requestdate).to_s+"\n"+inv.vd_requestfor.to_s,inv.totalsewa,currency_formatted(inv.ama_amount).to_s]
    end
end
