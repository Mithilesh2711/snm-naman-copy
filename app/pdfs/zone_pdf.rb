...
class ZonePdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Zone List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","ZoneCode", "ZoneNumber","ZoneName", "ZonalIncharge","InchargeMobileNo", "AdditionalContact","LandLineNo","Address","SNMEmail", "PersonalEmail", "ZoneOffice"]]+
    @invoice.each.map do |inv|
       [count,inv.zn_zonecode.to_s,inv.zn_number.to_s,inv.zn_name,inv.zn_incharge,inv.zn_inchmobile,inv.zn_addcontact,inv.zn_landlineno,inv.zn_inchargaddress,inv.zn_inchargesnm_email,inv.zn_zone_email,inv.zn_zoneoffice]
    end
end
#     
private
