...
class EscalationMatrixPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Escalation Matrix List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.","Code","Name","Status"]]+
      @invoice.each.map do |inv|
         [count,inv.em_code,inv.em_name,inv.em_status]
      end
  end
