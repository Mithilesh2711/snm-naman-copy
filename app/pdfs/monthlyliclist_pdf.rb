...
class MonthlyliclistPdf < Prawn::Document
...
data4 = ([
  [{:content =>"S No."}, {:content =>"Sewadar Code"},   {:content =>"Name"},{:content =>"Department"}, {:content =>"Lic Group"}],
...
style row(0..4000).column(2..4),  :size => 10, :align=> :center
...
if @salary && @salary.length >0
         @salary.each do |newsalry|
          ...
          data5 += ([
            [{:content =>mycount.to_s}, {:content =>newsalry.sw_sewcode.to_s},{:content =>newsalry.sw_sewadar_name.to_s},  {:content =>newsalry.departname.to_s}, {:content =>newsalry.so_licgroup.to_s}]
...
style row(0..4000).column(2..4), :align=> :left
end
