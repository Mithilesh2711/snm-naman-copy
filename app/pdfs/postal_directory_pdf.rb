...
class PostalDirectoryPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>PostalDirectory</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.","Code","Name","Country","State","District","Tehsil", "City", "Pincode", "Status"]]+
      @invoice.each.map do |inv|
         [count,inv.pd_code,inv.pd_name,inv.pd_country,inv.pd_state,inv.pd_district,inv.pd_tehsil,inv.pd_city,inv.pd_pincode,inv.pd_status]
      end
  end
