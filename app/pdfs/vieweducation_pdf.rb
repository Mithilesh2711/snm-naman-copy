...
class VieweducationPdf < Prawn::Document
  ...
  def line_items
        ...
        data4 = ([
                [{:content =>"S No."},{:content =>"Request No\nRequest Date\nApply For"},{:content =>"Sanction No\nSanction Date\nFinancial Year"},{:content =>"Sewdar Details"}, {:content =>"Aadhaar No\nDate of Birth"}, {:content => "Dependent\nFor Class\nAmount\nSchool/University"}, {:content =>"Remark"}, {:content =>"Forwarded By"}],
          ...
          table([] + data4,:width =>528)  do
            ...
            style row(0..1).column(0),   :width => 34
