...
class DispatchTypePdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Dispatch Type List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      ...
      @invoice.each.map do |inv|
         [count,inv.dt_code,inv.dt_name,inv.dt_status]
      end
  end
