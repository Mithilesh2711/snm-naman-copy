...
class CurrencyPdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Currency List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      ...
      @invoice.each.map do |inv|
         [count,inv.cur_code,inv.cur_name,inv.cur_status]
      end
  end
