...
class BranchPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Branch List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","BranchCode","BranchNumber","BranchName","Zone","DistrictZone","Address","Bhawan"]]+
    @invoice.each.map do |inv|
       [count,inv.bch_branchcode.to_s,inv.bch_branchnumber.to_s,inv.bch_branchname,inv.myzones,inv.myzonedistrict,inv.bch_address,inv.bch_bhawan]
    end
end
