...
class SewadartdsreportPdf < Prawn::Document
 ...
 move_down 10
 text "<b>Sewadar TDS Summary</b>" , :inline_format=> :true, :align=> :center,:size=>11
 text "<b>Financial Year : "+@gsess["requestyear"].to_s+"</b>" , :inline_format=> :true, :align=> :center,:size=>11
 text "<b>Sewadar Code : "+@gsess["requestsewacode"].to_s+"</b>" , :inline_format=> :true, :align=> :center,:size=>11
