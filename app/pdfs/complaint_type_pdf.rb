...
class ComplaintTypePdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Complaint Type List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      ...
      @invoice.each.map do |inv|
         [count,inv.ct_code,inv.ct_name,inv.ct_status]
      end
  end
