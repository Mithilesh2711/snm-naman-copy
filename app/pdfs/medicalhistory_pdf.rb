...
class MedicalhistoryPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Medical History List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","Type","Description","AnswerType"]]+
    @invoice.each.map do |inv|
       [count,inv.mh_other.to_s,inv.mh_description.to_s,inv.mh_answertype]
    end
end
