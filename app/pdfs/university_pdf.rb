...
class UniversityPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>University List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","Description","Qualification"]]+
    @invoice.each.map do |inv|
       [count,inv.un_description,inv.un_qltype]
    end
end
