...
class LanguagePdf < Prawn::Document
    ...
    def line_items
            ...
            move_down 10
            text "<b><u>Language List</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
            Time.zone = "Kolkata"         
   ...
   def line_item_rows   
      [["SlNo.","LanguageCode","Name","Status"]]+
      @invoice.each.map do |inv|
         [count,inv.lang_code,inv.lang_name,inv.status]
      end
  end
