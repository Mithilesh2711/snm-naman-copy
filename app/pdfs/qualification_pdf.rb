...
class QualificationPdf < Prawn::Document
  ...
  def line_items
          ...
          move_down 10
          text "<b><u>Qualification</u></b>", :align => :center, :size =>10,:font_weight=>:bold,:inline_format=> TRUE
          Time.zone = "Kolkata"         
 ...
 def line_item_rows   
    [["SlNo.","Qualification Code","Qualification In","Qualification","Duration","Is Professional\nQualification","Is International\nQualification"]]+
    @invoice.each.map do |inv|
       [count,inv.ql_qualifcode,inv.ql_qualdescription,inv.ql_qualification,inv.ql_duration,inv.ql_isprofessional,inv.ql_isinternational]
    end
end
