...
class SanctionedadvancedetailPdf < Prawn::Document
...
data5 = ([
  [{:content =>"S No."},{:content =>"Request No.\nDate Of Request\nAdvance Type"},{:content =>"Sewadar Code\n Old Code"},   {:content =>"Sewadar Name\nSewadar Department"}, {:content =>"Advance Amount\n Installment"},   {:content =>"Purpose\n Reason"}, {:content =>"Sanction No.\n Sanction Date"},{:content =>"Bank Account No.\n IFSC Code"},{:content =>"Bank Name"}],
  ...
  if @salary && @salary.length >0
    @salary.each do |newadv|                  
      ...
      leftinstdate    = newadv.leftinstallmentdate         
          data5 += ([
            [{:content =>mycount.to_s}, {:content =>newadv.al_requestno+"\n"+formatted_date(newadv.al_requestdate)+"\n"+requestype.to_s},{:content =>newadv.al_sewadarcode+"\n"+newadv.sw_oldsewdarcode}, {:content =>newadv.sw_sewadar_name+"\n"+newadv.departname},  {:content =>currency_formatted(totaladvan).to_s+"\n"+currency_formatted(newadv.al_installpermonth).to_s}, {:content =>newadv.al_purpose+"\n"+newadv.al_remark}, {:content =>newadv.sanctionno+"\n"+formatted_date(newadv.sanctiondate)}, {:content =>newadv.skb_accountno+"\n"+newadv.skb_ifccocde}, {:content =>newadv.skb_bank}]
