...
class ApproveeducationsPdf < Prawn::Document
  ...
  def line_items
        ...
        data4 = ([
          ...
          table([] + data4,:width =>528)  do
            ...
            style row(0..1).column(3),   :width => 87, :align => :center
            style row(0..1).column(4),   :width => 85 , :align => :center
            style row(0..1).column(5),   :width => 70 , :align => :center
            style row(0..1).column(6),   :width => 60 , :align => :center
            style row(0..1).column(7),   :width => 57 , :align => :left
