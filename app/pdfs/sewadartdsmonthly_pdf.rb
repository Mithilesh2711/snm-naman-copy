...
class SewadartdsmonthlyPdf < Prawn::Document
 ...
 if @salary && @salary.length > 0
     yyear = @salary[0].pm_payyear
 end
 text "<b>TDS Monthly Summary</b>" , :inline_format=> :true, :align=> :center
 #text "<b>Financial Year : "+@gsess["requestyear"].to_s+"</b>" , :inline_format=> :true, :align=> :center
 text "<b>For Month : "+monthsesh.to_s+","" "+yyear.to_s+"</b>" , :inline_format=> :true, :align=> :center
