class ResolveTicketIssueController < ApplicationController
  ...
  def get_ticket_list
     ...
     if params[:requestserver] !=nil && params[:requestserver] != ''
        ...
        session[:reqs_ticket_upto_dated] = nil
          ...
          from_date         = params[:from_date] !=nil && params[:from_date] != '' ? params[:from_date].to_s.strip : session[:reqs_ticket_from_date]
      ...
      if upto_date !=nil && upto_date !=''
            ...
            session[:reqs_ticket_upto_dated] = upto_date
      end
