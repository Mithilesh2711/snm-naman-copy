...
function filter_individual_head(){
  var useroot = $("#userXRoot").val();
  $("form#myforms").attr("action",useroot+"individual_head/search");   
  $("form#myforms").submit();
}
...
function search_city(){
    ...
    $.ajax({
        url: usePath+"individual_head/ajax_process",
        type: 'POST',
...
function get_city_by_district(){
    var usePath    = $.trim( $("#rootXPath").val() );
    var statecode  = $.trim( $("#ih_state").val() );
    var districtcode  = $.trim( $("#ih_district").val() );
