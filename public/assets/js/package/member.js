...
function filter_member(){
  ...
  $("form#myforms").attr("action",useroot+"member/search");   
  $("form#myforms").submit();
}
...
function search_city(){
    ...
    $.ajax({
        url: usePath+"member/ajax_process",
        type: 'POST',
...
function get_city_by_district(){
    var usePath    = $.trim( $("#rootXPath").val() );
    var statecode  = $.trim( $("#mbr_state").val() );
    var districtcode  = $.trim( $("#mbr_district").val() );
